class PostsController < ApplicationController
  ...
  def index
    ...
    @posts = @posts.where(bedroons: params["bedroons"]) if params["bedroons"].present?
    ...
    @posts = @posts.where("price > ?", params["min_sqft"]) if params["min_sqft"].present?
    @posts = @posts.where("price < ?", params["max_sqft"]) if params["max_sqft"].present?
